...
const milestones = [
  {
    ...
    body: "مهم‌ترین چیزی که مؤسسه آموزشی و شتاب‌دهی رکاد بهش می‌پردازه، فراهم‌سازی بستری برای رشد و پرورش نوجوونای ارزش‌آفرینه. رکاد از سال ۱۳۹۵ شروع کرد به کار کردن؛ به جای اینکه فقط مثل بقیه مدارس درس بده، تصمیم گرفت روی مقاطع نوجوان تمرکز کنه — با هدف استعدادیابی، رشد و تربیت نیروی انسانی مولد در سیستم استارتاپی و صنایع خلاق و دانش‌بنیان.",
  ...
  },
  {
    ...
    body: "سال ۱۳۹۸ نقطه‌ی عطف رکاد بود: تأسیس اولین هنرستان استارتاپی ایران در مشهد. اما این فقط یه اسم نبود، بلکه اینکه دانش‌آموز رکاد نه فقط به دیپلم، بلکه به مسیر شغلی واقعی برسه. امروز با گذشت ۶ سال، این مدرسه نرخ اشتغال بیش از ۷۵٪ رو بین دانش‌آموختگانش ثبت کرده.",
    rotation: "-rotate-[2deg]",
  ...
  },
  {
    ...
    body: "امروز رکاد به یه اکوسیستم زنده تبدیل شده که توش استارتاپ ویکندها، بوت‌کمپ‌ها، کالج تابستانه، فرهنگستان نوآوری و استودیو نوآوری دیجیتال کنار هم کار می‌کنن: +۲۲۰۰ نوجوان، ۳۱ استارتاپ، ۳۱ رویداد و همایش کارآفرینی، و ۵ شهر مهمان.",
