...
const milestones = [
  {
    ...
    highlight: { word: "رکاد", color: "text-teal" },
  ...
  },
  {
    ...
    highlight: { word: "اولین", color: "text-magenta" },
  ...
  },
  {
      ...
      highlight: { word: "اکوسیستم", color: "text-orange" },
            ...
            <div key={m.year} className="relative flex items-start gap-6 sm:gap-10 lg:gap-14">
              ...
              <div className="flex-1 pb-12 sm:pb-16 lg:pb-20 pt-1">
                <h3 className="font-black text-[1.375rem] sm:text-[1.875rem] lg:text-[2.125rem] leading-[1.3] mb-3 sm:mb-4 text-[#21295A]">
                  {m.title.split(m.highlight.word).map((part, i, arr) => (
                    <span key={i}>
                      {part}
                      {i < arr.length - 1 && (
                        <span className={m.highlight.color}>{m.highlight.word}</span>
                      )}
                    </span>
                  ))}
                </h3>
