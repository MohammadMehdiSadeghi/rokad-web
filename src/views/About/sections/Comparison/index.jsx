...
const rokadChecks = [
  "پروژه‌های واقعی از روز اول",
  "یادگیری با انجام‌دادن و کار تیمی",
  "آموزش شغلی و منتورینگ با آدم‌های واقعی",
  "ارتباط مستقیم با اکوسیستم استارتاپی و منتورهای مجرب",
  { text: "خروجی: دیپلم + مسیر شغلی روشن + پورتفولیو", highlight: true },
];

const regularChecks = [
  { text: "مهارت‌های نرم کم و صرفاً تئوری", cross: true },
  { text: "آموزش تئوریک بدون تجربهٔ واقعی", cross: true },
  { text: "یادگیری فردی و رقابتی", cross: true },
  { text: "ارتباط کم با صنعت", cross: true },
  { text: "خروجی: دیپلم بدون پروژه و پورتفولیو", cross: true, highlight: true },
];
