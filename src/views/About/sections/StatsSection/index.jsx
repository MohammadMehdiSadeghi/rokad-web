...
const THEMES = {
  orange: { back: "bg-orange-alt", border: "border-orange", text: "text-orange", bg: "#FEF7EC", src: YELLOW_TEXTURE, opacity: 100 },
    navy: { back: "bg-navy-alt", border: "border-navy", text: "text-navy-alt", bg: "#F4F5FB", src: BLUE_TEXTURE, opacity: 100 },
    magenta: { back: "bg-magenta", border: "border-magenta", text: "text-magenta-text", bg: "#FEFAFB", src: PINK_TEXTURE, opacity: 100 },
    teal: { back: "bg-teal-alt", border: "border-teal", text: "text-teal-text", bg: "#F2FAF9", src: GREEN_TEXTURE, opacity: 100 },
};
...
function StatCard({ theme, value, label }) {
  ...
  return (
    <div className="relative h-full">
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center ${shapeClass} border-[0.1875rem] ${t.border} px-3 xs:px-4 pt-3 xs:pt-5 pb-3 xs:pb-5 lg:px-5 lg:pt-6 lg:pb-6 text-center overflow-visible">
              <div className={`absolute inset-0 ${shapeClass} pointer-events-none`} style={{ backgroundColor: t.bg, opacity: 0.2 }} />
