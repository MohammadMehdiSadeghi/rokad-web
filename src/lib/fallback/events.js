// src/lib/fallback/events.js
// سه رویداد واقعی رکاد — هر کدوم صفحه اختصاصی خودشون رو دارن
const fallbackEvents = [
  {
    ...
    meta: "مشهد | ۳۱ شهریور — ۳ مهر ۱۴۰۴",
  ...
  },
  {
    index: "۰۳",
    theme: "girls",
    category: "جمع‌بندی سال",
    badge: "پایان سال",
    title: "رکاپ ۴",
    meta: "مشهد | ۶ — ۱۰ تیر ۱۴۰۵",
