...
import { C as setInnerHTML, S as setCSSProperty, _ as getTranslate, a as elementIndex, b as nextTick, d as elementPrevAll, f as elementStyle, i as elementChildren, l as elementOuterSize, m as extend$1, n as createElement, o as elementIsChildOf, r as deleteProps, s as elementNextAll, u as elementParents, w as showWarning, x as now } from "./utils-DbJqq1QE.js";
...
function extend(target, src) {
	...
	Object.keys(s).filter((key) => noExtend.indexOf(key) < 0).forEach((key) => {
		...
		if (typeof targetVal === "undefined") t[key] = srcVal;
			...
			if (srcVal.__swiper__) t[key] = srcVal;
...
function updateSwiper(args) {
	...
	if (changedParams.includes("loop") && swiper.isElement) {
		if (currentParams.loop && !passedParams.loop) loopNeedDestroy = true;
...
var Swiper = (0, import_react.forwardRef)(function Swiper(propsArg, externalElRef) {
	...
	useIsomorphicLayoutEffect(() => {
		if (externalElRef) {
			if (typeof externalElRef === "function") externalElRef(swiperElRef.current);
...
var SwiperSlide = (0, import_react.forwardRef)(function SwiperSlide(props, externalRef) {
	...
	useIsomorphicLayoutEffect(() => {
		...
		if (externalRef) {
			if (typeof externalRef === "function") externalRef(slideElRef.current);
