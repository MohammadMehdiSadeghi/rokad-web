...
const pillars = [
  {
    ...
    body: "دانش‌آموز به جای حفظ کردن، پروژه‌های واقعی حل می‌کنه و مهارت‌هایی رو کسب می‌کنه که فوراً قابل استفاده‌اند.",
    iconBg: "bg-teal",
  ...
  },
  {
    ...
    body: "دانش‌آموزان به تیم در جهت حل مسائل و پیشرفت رقابتی همکاری می‌کنن نه به صورت انفرادی و رقابتی.",
    iconBg: "bg-magenta",
    rotation: "rotate-[1.5deg]",
  },
  {
    ...
    body: "نه فقط مهارت‌های تئوری و طراحی، بلکه خودشناسی، تفکر انتقادی کار تیمی همه مهارت‌های نرمی که فردآزمونه.",
    iconBg: "bg-navy",
    rotation: "-rotate-[1.5deg]",
  },
  {
    ...
    body: "دانش‌آموز توی مسیر رشد فردی با اهداف مشترک و کوچینگ و منتورینگ مستمر همراهی می‌شه نه به تنهایی.",
    iconBg: "bg-orange",
    rotation: "rotate-[1.5deg]",
  },
];
