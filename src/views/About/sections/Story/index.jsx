...
const milestones = [
  {
    ...
    label: "سال شروع",
    titleParts: [
      { text: "مسئله‌ای که ", color: "text-[#202a5a]" },
      { text: "رکاد", color: "text-teal" },
      { text: " براش ساخته شد", color: "text-[#202a5a]" },
    ],
  ...
  },
  {
    ...
    titleParts: [
      { text: "تأسیس ", color: "text-[#202a5a]" },
      { text: "اولین", color: "text-magenta" },
      { text: " هنرستان استارتاپی ایران", color: "text-[#202a5a]" },
    ],
  ...
  },
  {
      ...
      titleParts: [
        ...
        { text: " نه فقط یه مدرسه", color: "text-[#202a5a]" },
      ],
                  ...
                  {milestones.map((m, i) => (
                    <div key={m.year} className="relative grid grid-cols-[auto_auto_1fr] items-start gap-8 sm:gap-10 lg:gap-12">
                      ...
                      <div className="pt-2 pb-12 sm:pb-16 lg:pb-20">
                        <h3 className="font-black text-[1.375rem] sm:text-[1.875rem] lg:text-[2.125rem] leading-[1.3] mb-3 sm:mb-4 text-[#202a5a]">
